    ...
    <Layout>
      <div className="contact">
        <div className="contact-content">
          <h2>Best Price of the Era</h2>
          <h1>
            {" "}
            <a href="#"> BGS Addres logged In...!</a>
          </h1>
          <p>Congrates ....</p>
          <p>
            Address: Apartment 20501, 4Cal End, Trafford Park, Usa, M17 1HZ
            (edit)
          </p>
        ...
        <div className="contact-form">
          <h5>Enter your details below to get quotes</h5>
          <p>
            {" "}
            <CiCircleCheck />
            We’ve helped over 90,000 businesses
          </p>
          <div>
            <form>
              <div className="mt-3">
