...
import guides from "../assets/images/Home/guides1.jpg";
    ...
    <Layout>
          ...
          <div className="block-banner-page p-4">
            <div className="header--page__inner ">
              <div className="header--page__content">
                <h1>Via Bgs tip & save money</h1>
                <div className="banner-content">
                  <p>
                    Explore our comprehensive selection of business energy and
                    utility guides, tailored to optimize your operational
          ...
          <div className="wrpper-content-area">
            <div className="wrapper-content">
              <p>
                ...
                top bgs and energy suppliers to offer our customers the best
                live quotes.
              </p>
            </div>
      ...
      <div className="home-switch">
        ...
        <p>
          ...
          your business massively save on your business utilities. bgs energy
                  ...
                  <div className="block col-1-1__block block--1">
                    <div className="w-titles">
                      ...
                      <p className="home-deals-p">
                        ...
                        time. Here at bgs energy, we understand the value of
      ...
      <div className="home-award">
        <div className="home-awards">
          <div className="home-awards-content">
            ...
            <div>
              <p>
                bgs energy won the prestigious ‘Best Customer Service’ award for
                ...
                service, the whole bgs energy team was really pleased to receive
                the 2019 TELCA award in recognition for our efforts.
              </p>
              <p>
                bgs energy also won Best Business Utilities Comparison Service
        ...
        <div className="home-energy">
          <div>
            ...
            <p>
              ...
              become more competitive. Working with bgs energy, you can find a
