    ...
    <Layout>
      <div className="contact">
        <div className="contact-form">
          <h5 className="text-light">By BGS please select a bgs</h5>
          <p>
            {" "}
            <CiCircleCheck />
            Save up to 65%
          ...
          <div>
            <div className="best-price">
              <div className="home-supply"  onClick={handleClick}>
                <div className="best-price-icons">
                  <ImFire />
                </div>
        ...
        <div className="contact-content">
          ...
          <h1>
            {" "}
            Address<strong>locked</strong> In , please{" "}
          ...
          <p>Address: BGS Energy & Supplyment</p>
